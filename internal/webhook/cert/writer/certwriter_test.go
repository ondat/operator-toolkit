...
func (f *fakeCertReadWriter) read(ctx context.Context) (*generator.Artifacts, error) {
...
func (f *fakeCertReadWriter) write(ctx context.Context) (*generator.Artifacts, error) {
...
func (f *fakeCertReadWriter) overwrite(ctx context.Context) (*generator.Artifacts, error) {
...
var _ = Describe("handleCommon", func() {
	...
	Context("when DNS name is empty", func() {
		It("should return an error", func() {
			...
			_, _, err := handleCommon(ctx, "", certrw)
	...
	Context("when certReadWriter is nil", func() {
		It("should return an error", func() {
			_, _, err := handleCommon(ctx, dnsName, nil)
	...
	Context("cert doesn't exist", func() {
		It("should return no error on successful write", func() {
			...
			certs, changed, err := handleCommon(ctx, dnsName, certrw)
		...
		It("should return the error on failed write", func() {
			...
			_, _, err := handleCommon(ctx, dnsName, certrw)
